...
import com.sf.common.utils.HttpContextUtils;
import com.sf.common.utils.IPUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.sf.common.annotation.Log)")
    ...
    void saveLog(ProceedingJoinPoint joinPoint, long time) throws InterruptedException {
        ...
        Log sysLog = new Log();
        com.sf.common.annotation.Log syslog = method.getAnnotation(com.sf.common.annotation.Log.class);
        if (syslog != null) {
            // 注解上的描述
